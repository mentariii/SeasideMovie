...
public class detail_perfect extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_perfect);

        View alerrtCustomDialog = LayoutInflater.from(detail_perfect.this).inflate(R.layout.wishlist, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(detail_perfect.this);
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_perfect.this, "Canceled", Toast.LENGTH_SHORT).show();
            }
        });
        cv_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_perfect.this, "Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(detail_perfect.this, ini_menu);
        ...
        btn_view2.setOnClickListener(view -> {
            Intent Gotv_more = new Intent(detail_perfect.this, preview_perfect.class);
            startActivity(Gotv_more);
        });
        iv_back = findViewById(R.id.iv_back);
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(detail_perfect.this, MainActivity.class);
