...
public class TheGiftedd_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_the_giftedd_detail);

        View alerrtCustomDialog = LayoutInflater.from(TheGiftedd_detail.this).inflate(R.layout.wishlist, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(TheGiftedd_detail.this);
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(TheGiftedd_detail.this, "Canceled", Toast.LENGTH_SHORT).show();
            }
        });
        cv_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(TheGiftedd_detail.this, "Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(TheGiftedd_detail.this, ini_menu);
        ...
        btn_view2.setOnClickListener(view -> {
            Intent Gobtn_view = new Intent(TheGiftedd_detail.this, detailGifted1.class);
            startActivity(Gobtn_view);
        });
        iv_back = findViewById(R.id.iv_back);
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(TheGiftedd_detail.this, MainActivity.class);
