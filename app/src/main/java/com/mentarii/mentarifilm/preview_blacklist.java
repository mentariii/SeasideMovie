...
public class preview_blacklist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_blacklist);

        ini_menu = findViewById(R.id.ini_menu);
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(preview_blacklist.this, ini_menu);
        ...
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(preview_blacklist.this, detail_blacklist.class);
