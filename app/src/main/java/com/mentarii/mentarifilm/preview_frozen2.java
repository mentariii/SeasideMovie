...
public class preview_frozen2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_frozen2);

        ini_menu = findViewById(R.id.ini_menu);
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(preview_frozen2.this, ini_menu);
        ...
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(preview_frozen2.this, detail_frozen2.class);
