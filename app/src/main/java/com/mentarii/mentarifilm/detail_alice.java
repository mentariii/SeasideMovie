...
public class detail_alice extends AppCompatActivity {

    CardView btn_view2, cv_add;
    ImageView iv_back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_alice);

        View alerrtCustomDialog = LayoutInflater.from(detail_alice.this).inflate(R.layout.wishlist, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(detail_alice.this);
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_alice.this, "Canceled", Toast.LENGTH_SHORT).show();
            }
        });
        cv_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_alice.this, "Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(detail_alice.this, ini_menu);
        ...
        btn_view2.setOnClickListener(view -> {
            Intent Gotv_more = new Intent(detail_alice.this, preview_alice.class);
            startActivity(Gotv_more);
        });

        iv_back = findViewById(R.id.iv_back);
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(detail_alice.this, MainActivity.class);
