...
public class detail_myname extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_myname);

        View alerrtCustomDialog = LayoutInflater.from(detail_myname.this).inflate(R.layout.wishlist, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(detail_myname.this);
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_myname.this, "Canceled", Toast.LENGTH_SHORT).show();
            }
        });
        cv_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_myname.this, "Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(detail_myname.this, ini_menu);
        ...
        btn_view2.setOnClickListener(view -> {
            Intent Gotv_more = new Intent(detail_myname.this, preview_myname.class);
            startActivity(Gotv_more);
        });
        iv_back = findViewById(R.id.iv_back);
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(detail_myname.this, MainActivity.class);
