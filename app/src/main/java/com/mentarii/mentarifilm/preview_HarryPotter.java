...
public class preview_HarryPotter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_preview_harry_potter);
        ini_menu = findViewById(R.id.ini_menu);
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(preview_HarryPotter.this, ini_menu);
        ...
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(preview_HarryPotter.this, detailHarryPotter.class);
