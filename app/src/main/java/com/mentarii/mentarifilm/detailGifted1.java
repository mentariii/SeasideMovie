...
public class detailGifted1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_gifted1);

        ini_menu = findViewById(R.id.ini_menu);
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(detailGifted1.this, ini_menu);
        ...
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(detailGifted1.this, TheGiftedd_detail.class);
