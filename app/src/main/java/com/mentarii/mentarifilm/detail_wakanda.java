...
public class detail_wakanda extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_wakanda);

        View alerrtCustomDialog = LayoutInflater.from(detail_wakanda.this).inflate(R.layout.wishlist, null);
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(detail_wakanda.this);
        ...
        iv_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_wakanda.this, "Canceled", Toast.LENGTH_SHORT).show();
            }
        });
        cv_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dialog.cancel();
                Toast.makeText(detail_wakanda.this, "Added", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        ini_menu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                PopupMenu popupMenu = new PopupMenu(detail_wakanda.this, ini_menu);
        ...
        btn_view2.setOnClickListener(view -> {
            Intent Gotv_more = new Intent(detail_wakanda.this, preview_wakanda.class);
            startActivity(Gotv_more);
        });
        iv_back = findViewById(R.id.iv_back);
        iv_back.setOnClickListener(view -> {
            Intent Goiv_back = new Intent(detail_wakanda.this, MainActivity.class);
